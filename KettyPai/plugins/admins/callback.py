...
from KettyPai.utils.formatters import seconds_to_min
from KettyPai.utils.inline import close_markup, stream_markup, stream_markup_timer
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await KettyPai.pause_stream(chat_id)
        ...
        await KettyPai.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
