...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("KettyPai/assets/font2.ttf", 30)
        font = ImageFont.truetype("KettyPai/assets/font.ttf", 30)
        title_font = ImageFont.truetype("KettyPai/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("KettyPai/assets/play_icons.png")
